...
class SendGrid_NLVX_Widget extends WP_Widget {
    ...
    private function display_form() {
      ...
      echo '  <div class="sendgrid_mc_input_div">';
      echo  '<fieldset>';
      echo '   <input class=" sendgrid_mc_input sendgrid_mc_input_email myForm" id="sendgrid_mc_email" name="sendgrid_mc_email" type="text" value="" placeholder="Ваш email" required/>';
      echo  '</fieldset>';
      echo  '<fieldset>';
      echo '   <input class=" sendgrid_mc_button myForm" type="submit" id="sendgrid_mc_email_submit" value=" Подписаться на рассылку" />';
      echo  '</fieldset>';
      echo '  </div>';
      echo '</div>';
