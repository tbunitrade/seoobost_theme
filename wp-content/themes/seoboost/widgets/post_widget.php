...
class dash_latest_news_widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		?>
			<p class="myLabel">Последние статьи</p>
				...
				<li>
					...
					<div class="side-item">
						...
						<div class="side-image">
							...
							<a href="<?php echo esc_url(get_permalink()) ?>" rel="bookmark"><?php the_post_thumbnail('random-thumb-11', array('class' => 'side-item-thumb')); ?></a>
