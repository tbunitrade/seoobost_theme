	...
	?>
	 <?php if($breadcrumb_type == 'normal'): ?>
        	...
        	<ul class="entry-meta list-inline">
				...
				<li class="meta-comment list-inline-item copyContainer">
    				<input id="foo" type="text" value="">
    				<button class="btn" id="myId" data-clipboard-action="copy" data-clipboard-target="#foo" s>Copy</button>
					<a href="#" id="sendLink" onclick="itsAmagic()" ><i class="fas fa-link"> </i> Поделиться</a>
					<p id="linkToCopy" class="copyLink btn-clipboard" data-clipboard-target="#linkToCopy"></p>
				</li>	
			<div>
	</div>					
				...
				<script>
						...
						function stopDefAction(evt) {
							...
							document.getElementById('sendLink').addEventListener(
					...
					function itsAmagic() {
						...
						document.getElementById("foo").value = url;
						console.log('My url' + url);
						document.getElementById("linkToCopy").innerHTML = "Ссылка скопирована";
						var myobject = document.getElementById("linkToCopy");
						myobject.classList.add("blockMe") ;

						setTimeout(() => {
							myobject.classList.remove("blockMe") ;
						}, 1000);
		...
		<!-- <?php #if ( has_post_thumbnail() ) : ?>
            <div class="post-thumbnail">
                <?php #the_post_thumbnail('seoboost-thumbnail-11'); ?>
            </div>
		<?php #endif; ?> -->
		...
		<?php if(has_tag()): ?>
			<div class="tag-list myList" ><?php the_tags( '<i class="fa fa-tags" aria-hidden="true"></i>'); ?></div>
		<?php endif; ?>
		<?php endif; ?>
		...
		<div class="socialLeft">
			...
			<div class="share-text">Мои соц. сети</div>
			<div class="social-share">
				<ul>
				<li><a class="hint--top" data-hint="Google-plus" target="_blank" href="https://vk.com/share?url=<?php the_permalink(); ?>">
				...
				<g>
					...
					<li><a class="hint--top" data-hint="Facebook" target="_blank" href="https://www.facebook.com/sharer/sharer.php?url=<?php the_permalink(); ?>">
					...
					<li><a class="hint--top" data-hint="Twitter" target="_blank" href="https://twitter.com/home?status=Check%20out%20this%20article:%20<?php print seoboost_social_title( get_the_title() ); ?>%20-%20<?php echo urlencode(the_permalink()); ?>">
					<svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 						viewBox="0 0 18.001 18.001" style="enable-background:new 0 0 18.001 18.001;" xml:space="preserve">
						
							<g>
								<path  d="M15.891,4.013c0.808-0.496,1.343-1.173,1.605-2.034c-0.786,0.417-1.569,0.703-2.351,0.861
					...
					<li><a class="hint--top" data-hint="Pinterest" data-pin-do="skipLink" target="_blank" href="https://telegram.me/share/url?url=<?php the_permalink(); ?>&media=<?php echo $pin_image; ?>&description=<?php the_title(); ?>">
